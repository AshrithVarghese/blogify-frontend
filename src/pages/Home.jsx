...
function Home() {
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      {/* <div>
        <img src="images/undraw_blog-post_f68f.svg" alt="" className="absolute w-[200px] left-[22vw] top-[15vh] sm:right-[20vw] z-1 md:left-[15vw] md:top-[40vh] md:w-[300px]" />
        <img src="images/assets/undraw_publish-post_7g2z.svg" alt="" className="absolute w-[200px] left-[15vw] bottom-[-400px] z-1 md:top-[40vh] md:left-[67vw] md:w-[300px]" />
      </div> */}
